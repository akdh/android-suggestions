...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private List<Integer> mGroupViews = new ArrayList<Integer>();
    private Map<Integer,View> mChildViews = new HashMap<Integer,View>();
...
//									intent.putExtra(EXTRA_USERID, SuggestionList.userid);
    ...
    public Boolean getGroupDisabled(int groupPosition) {
		return mGroupViews.contains(groupPosition);
    }
    
    public View getChildView(int groupPosition) {
		return mChildViews.get(groupPosition);
    }
